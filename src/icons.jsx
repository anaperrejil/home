// MERIS — Lucide-style inline icon set (stroke 1.5, currentColor)
// Only the glyphs this prototype needs. Visual match to Lucide per DS mandate.
const ICON_PATHS = {
  ...
  'grid-3': '<rect width="7" height="18" x="3" y="3" rx="1.5"/><rect width="7" height="18" x="14" y="3" rx="1.5"/>',
  ...
  'grip': '<circle cx="5" cy="7" r="1"/><circle cx="12" cy="7" r="1"/><circle cx="19" cy="7" r="1"/><circle cx="5" cy="13" r="1"/><circle cx="12" cy="13" r="1"/><circle cx="19" cy="13" r="1"/>',
  'message-square-plus': '<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><line x1="9" y1="10" x2="15" y2="10"/><line x1="12" y1="7" x2="12" y2="13"/>',
...
// MERIS monogram mark — white "M" glyph (from the wordmark) on a near-black rounded square.
function MerisMark({ size = 28, radius = 7 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0 }}>
      <rect width="40" height="40" rx={radius} fill="#09090B" />
      <svg x="6" y="6" width="28" height="28" viewBox="90 196 178 196">
        <path fill="#FFFFFF" d="M102.49,213.7v172.32h-7.63v-184.16h8.42l78.14,107.6,77.87-107.6h8.16v184.16h-7.63v-172.58l-77.08,106.29h-3.16l-77.08-106.02Z" />
      </svg>
    </svg>
  );
}

Object.assign(window, { Icon, MerisMark, ICON_PATHS });
